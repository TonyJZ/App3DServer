...
var RainDrainPipeParams = [{
  ...
  routeArray: [{
    ...
    route: [[598.578, 471.635, 4.0], [599.578, 471.635, 4.0], [599.578, 470.635, 4.0]],
    segStyle: style_segment_turn
  }, {
    route: [[599.578, 470.635, 4.0], [599.645, 442.692, 4.0]],
    segStyle: style_segment_long
  }, {
    route: [[599.645, 442.692, 4.0], [599.645, 441.692, 4.0], [598.645, 441.692, 4.0]],
    segStyle: style_segment_turn
  }, {
    route: [[598.645, 441.692, 4.0], [539.306, 441.664, 4.0]],
    segStyle: style_segment_long
  }, {
    route: [[539.306, 441.664, 4.0], [538.306, 441.664, 4.0], [527.108, 435.979, 4.0], [527.108, 434.979, 4.0]],
  ...
  pipeStyle: style_green,
  routeArray: [{
    route: [[551.752, 203.676, 4.0], [538.745, 203.676, 4.0], [527.299, 203.08, 4.0]],
    segStyle: style_segment_zero
  }]
}, {
  name: "Line040",
  ...
  routeArray: [{
    ...
    route: [[605.212, 405.116, 4.0], [606.212, 405.116, 4.0], [606.212, 406.116, 4.0]],
    segStyle: style_segment_turn
  }, {
    route: [[606.212, 406.116, 4.0], [606.224, 434.859, 4.0]],
    segStyle: style_segment_long
  }, {
    route: [[606.224, 434.859, 4.0], [606.224, 435.859, 4.0], [605.276, 436.7, 4.0]],
    segStyle: style_segment_turn
  }, {
  ...
  routeArray: [{
    ...
    route: [[716.062, 450.891, 4.0], [717.062, 450.891, 4.0], [717.062, 449.891, 4.0]],
    segStyle: style_segment_turn
  }, {
    route: [[717.062, 449.891, 4.0], [717.202, 349.138, 4.0]],
    segStyle: style_segment_long
  }, {
    route: [[717.202, 349.138, 4.0], [717.202, 348.138, 4.0], [716.202, 348.138, 4.0]],
    segStyle: style_segment_turn
  }, {
    route: [[716.202, 348.138, 4.0], [708.178, 348.134, 4.0]],
    segStyle: style_segment_long
  }, {
    route: [[708.178, 348.134, 4.0], [707.178, 348.134, 4.0], [707.178, 347.134, 4.0]],
    segStyle: style_segment_turn
  }, {
  ...
  routeArray: [{
    ...
    route: [[649.005, 415.238, 4.0], [649.005, 414.238, 4.0], [650.005, 414.238, 4.0]],
    segStyle: style_segment_turn
  }, {
  ...
  routeArray: [{
    ...
    route: [[193.371, 1334.142, 4.0], [193.371, 1333.142, 4.0], [198.394, 1325.739, 4.0], [198.428, 1293.86, 4.0], [198.489, 1292.86, 4.0]],
    segStyle: style_segment_zero
  }, {
    route: [[198.489, 1292.86, 4.0], [224.824, 861.201, 4.0]],
    segStyle: style_segment_long
  }, {
    route: [[224.824, 861.201, 4.0], [224.885, 860.201, 4.0], [225.885, 860.201, 4.0]],
    segStyle: style_segment_turn
  }, {
    route: [[225.885, 860.201, 4.0], [420.753, 860.379, 4.0]],
    segStyle: style_segment_long
  }, {
    route: [[420.753, 860.379, 4.0], [421.753, 860.379, 4.0], [437.27, 856.856, 4.0], [438.27, 856.856, 4.0]],
    segStyle: style_segment_zero
  }, {
  ...
  pipeStyle: style_green,
  routeArray: [{
    route: [[223.219, 1014.641, 4.0], [226.12, 1016.536, 4.0], [226.12, 1017.536, 4.0]],
    segStyle: style_segment_zero
  }, {
    route: [[226.12, 1017.536, 4.0], [225.993, 1099.445, 4.0]],
    segStyle: style_segment_long
  }, {
    route: [[225.993, 1099.445, 4.0], [225.993, 1100.445, 4.0], [226.993, 1100.445, 4.0]],
    segStyle: style_segment_turn
  }, {
    route: [[226.993, 1100.445, 4.0], [268.905, 1100.475, 4.0]],
    segStyle: style_segment_long
  }, {
    route: [[268.905, 1100.475, 4.0], [269.905, 1100.475, 4.0], [269.905, 1101.475, 4.0]],
    segStyle: style_segment_turn
  }, {
  ...
  routeArray: [{
    ...
    route: [[338.315, 1409.161, 4.0], [338.315, 1410.161, 4.0], [337.315, 1410.161, 4.0]],
    segStyle: style_segment_turn
  }, {
  ...
  routeArray: [{
    ...
    route: [[507.924, 1308.768, 4.0], [508.924, 1308.768, 4.0], [515.739, 1307.61, 4.0], [516.739, 1307.61, 4.0]],
    segStyle: style_segment_zero
  }, {
    route: [[516.739, 1307.61, 4.0], [586.844, 1307.771, 4.0]],
    segStyle: style_segment_long
  }, {
    route: [[586.844, 1307.771, 4.0], [587.844, 1307.771, 4.0], [587.844, 1308.771, 4.0]],
    segStyle: style_segment_turn
  }, {
  ...
  routeArray: [{
    ...
    route: [[502.487, 1405.199, 4.0], [503.487, 1405.199, 4.0], [517.63, 1404.793, 4.0], [517.63, 1403.793, 4.0]],
    segStyle: style_segment_zero
  }, {
    route: [[517.63, 1403.793, 4.0], [517.686, 1330.756, 4.0]],
    segStyle: style_segment_long
  }, {
    route: [[517.686, 1330.756, 4.0], [517.686, 1329.756, 4.0], [515.738, 1307.606, 4.0], [515.738, 1306.606, 4.0]],
    segStyle: style_segment_zero
  }, {
    route: [[515.738, 1306.606, 4.0], [515.928, 1119.684, 4.0]],
    segStyle: style_segment_long
  }, {
    route: [[515.928, 1119.684, 4.0], [515.928, 1118.684, 4.0], [514.928, 1118.684, 4.0]],
    segStyle: style_segment_turn
  }, {
  ...
  pipeStyle: style_green,
  routeArray: [{
    route: [[571.689, 1409.414, 4.0], [558.197, 1409.438, 4.0], [547.968, 1404.563, 4.0], [536.633, 1382.753, 4.0]],
    segStyle: style_segment_zero
  }]
}, {
  name: "Line086",
  ...
  pipeStyle: style_green,
  routeArray: [{
    route: [[554.708, 1393.673, 4.0], [558.139, 1382.703, 4.0], [536.63, 1382.746, 4.0], [517.648, 1379.038, 4.0]],
    segStyle: style_segment_zero
  }]
}, {
  name: "Line089",
  ...
  routeArray: [{
    ...
    route: [[707.224, 1119.811, 4.0], [707.224, 1118.811, 4.0], [706.224, 1118.811, 4.0]],
    segStyle: style_segment_turn
  }, {
  ...
  pipeStyle: style_green,
  routeArray: [{
    route: [[527.696, 1236.719, 4.0], [548.507, 1236.755, 4.0], [561.235, 1244.924, 4.0]],
    segStyle: style_segment_zero
  }]
}, {
  name: "Line099",
  pipeStyle: style_green,
  routeArray: [{
    route: [[582.9, 1416.376, 4.0], [583.328, 1411.386, 4.0], [587.738, 1404.798, 4.0]],
    segStyle: style_segment_zero
  }]
}, {
  name: "Line100",
  pipeStyle: style_green,
  routeArray: [{
    route: [[699.443, 1383.401, 4.0], [711.344, 1383.422, 4.0], [711.367, 1342.636, 4.0], [680.757, 1325.709, 4.0], [644.745, 1326.499, 4.0], [642.674, 1332.517, 4.0], [632.662, 1345.069, 4.0], [628.136, 1357.723, 4.0], [624.331, 1378.09, 4.0], [621.802, 1387.196, 4.0], [613.424, 1402.023, 4.0], [601.97, 1406.673, 4.0], [587.737, 1406.607, 4.0]],
    segStyle: style_segment_zero
  }]
}, {
  name: "Line101",
  ...
  pipeStyle: style_green,
  routeArray: [{
    route: [[640.873, 1382.364, 4.0], [634.678, 1381.11, 4.0], [624.393, 1377.74, 4.0]],
    segStyle: style_segment_zero
  }]
}, {
  name: "Line113",
  ...
  pipeStyle: style_green,
  routeArray: [{
    route: [[594.551, 1394.114, 4.0], [594.007, 1398.69, 4.0], [602.547, 1406.435, 4.0]],
    segStyle: style_segment_zero
  }]
}];