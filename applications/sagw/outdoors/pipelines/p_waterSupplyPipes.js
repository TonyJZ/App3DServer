...
var WaterSupplyPipeParams = [
  ...
  },
  {
    ...
    routeArray: [
      ...
      {
        route: [
          [699.581, 1092.857, 4.0],
          [698.581, 1092.857, 4.0],
          [698.581, 1093.857, 4.0]
        ],
        segStyle: style_segment_turn
      },
      {
      ...
      {
        route: [
          [698.581, 1135.813, 4.0],
          [698.581, 1136.813, 4.0],
          [697.581, 1136.813, 4.0]
        ],
        segStyle: style_segment_turn
      },
      {
      ...
      {
        route: [
          [524.709, 1136.694, 4.0],
          [523.709, 1136.694, 4.0],
          [523.709, 1137.694, 4.0]
        ],
        segStyle: style_segment_turn
      },
      {
      ...
      {
        route: [
          [523.658, 1221.771, 4.0],
          [523.658, 1222.771, 4.0],
          [524.658, 1222.771, 4.0]
        ],
        segStyle: style_segment_turn
      },
      {
      ...
      {
        route: [
          [532.678, 1222.771, 4.0],
          [533.678, 1222.771, 4.0],
          [533.678, 1223.771, 4.0]
        ],
        segStyle: style_segment_turn
      },
      {
  ...
  },
  {
    ...
    routeArray: [
      ...
      {
        route: [
          [703.347, 1114.306, 4.0],
          [704.347, 1114.306, 4.0],
          [704.347, 1115.306, 4.0]
        ],
        segStyle: style_segment_turn
      },
      {
  ...
  },
  {
    ...
    routeArray: [
      ...
      {
        route: [
          [477.179, 1114.142, 4.0],
          [476.179, 1114.142, 4.0],
          [476.179, 1113.142, 4.0]
        ],
        segStyle: style_segment_turn
      },
      {
  ...
  },
  {
    ...
    routeArray: [
      ...
      {
        route: [
          [662.669, 1133.588, 4.0],
          [662.669, 1134.588, 4.0],
          [663.669, 1134.588, 4.0]
        ],
        segStyle: style_segment_turn
      },
      {
  ...
  },
  {
    ...
    routeArray: [
      ...
      {
        route: [
          [566.195, 1303.294, 4.0],
          [566.195, 1304.294, 4.0],
          [565.195, 1304.294, 4.0]
        ],
        segStyle: style_segment_turn
      },
      {
  ...
  },
  {
    ...
    routeArray: [
      ...
      {
        route: [
          [261.636, 1277.423, 4.0],
          [261.636, 1276.423, 4.0],
          [260.636, 1276.423, 4.0]
        ],
        segStyle: style_segment_turn
      },
      {
  ...
  },
  {
    ...
    routeArray: [
      ...
      {
        route: [
          [213.751, 1299.378, 4.0],
          [212.751, 1299.378, 4.0],
          [212.751, 1298.378, 4.0]
        ],
        segStyle: style_segment_turn
      },
      {
      ...
      {
        route: [
          [212.751, 1277.017, 4.0],
          [212.751, 1276.017, 4.0],
          [213.751, 1276.017, 4.0]
        ],
        segStyle: style_segment_turn
      },
      {
      ...
      {
        route: [
          [231.845, 1276.017, 4.0],
          [232.845, 1276.017, 4.0],
          [232.845, 1277.017, 4.0]
        ],
        segStyle: style_segment_turn
      },
      {
  ...
  },
  {
    ...
    routeArray: [
      ...
      {
        route: [
          [203.658, 1386.555, 4.0],
          [203.658, 1387.555, 4.0],
          [204.658, 1387.555, 4.0]
        ],
        segStyle: style_segment_turn
      },
      {
    ...
    routeArray: [
      ...
      },
      {
        route: [
          [599.55, 1425.049, 4.0],
          [600.55, 1425.031, 4.0],
          [621.329, 1422.075, 4.0],
          [695.547, 1402.849, 4.0],
          [706.439, 1390.192, 4.0],
          [712.568, 1374.309, 4.0],
          [712.561, 1371.175, 4.0]
        ],
  ...
  },
  {
    ...
    routeArray: [
      ...
      {
        route: [
          [349.193, 1416.286, 4.0],
          [350.193, 1416.286, 4.0],
          [355.827, 1410.88, 4.0],
          [356.827, 1410.88, 4.0]
        ],
        segStyle: style_segment_zero
      ...
      {
        route: [
          [559.432, 1411.548, 4.0],
          [560.432, 1411.548, 4.0],
          [598.211, 1410.914, 4.0],
          [604.226, 1410.016, 4.0],
          [612.679, 1406.158, 4.0],
          [617.51, 1401.687, 4.0],
          [624.347, 1386.591, 4.0],
          [633.067, 1349.87, 4.0],
          [637.767, 1342.295, 4.0],
          [647.124, 1333.064, 4.0],
          [659.931, 1333.064, 4.0],
          [668.523, 1326.453, 4.0]
        ],
        segStyle: style_segment_zero
      }
    ]
