...
var CompressedAirPipeParams = [
  ...
  },
  {
    ...
    routeArray: [
      ...
      {
        route: [
          [233.433, 1275.988, 4.0],
          [233.433, 1274.988, 4.0],
          [232.433, 1274.988, 4.0]
        ],
        segStyle: style_segment_turn
      },
      {
      ...
      {
        route: [
          [213.441, 1274.988, 4.0],
          [212.441, 1274.988, 4.0],
          [212.441, 1275.988, 4.0]
        ],
        segStyle: style_segment_turn
      },
      {
      ...
      {
        route: [
          [212.394, 1329.074, 4.0],
          [212.394, 1330.074, 4.0],
          [213.394, 1330.074, 4.0]
        ],
        segStyle: style_segment_turn
      },
      {
