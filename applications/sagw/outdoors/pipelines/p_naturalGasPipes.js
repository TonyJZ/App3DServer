...
var NaturalGasPipeParams = [
  ...
  },
  {
    ...
    routeArray: [
      ...
      {
        route: [
          [704.549, 1141.874, 4.0],
          [703.549, 1141.874, 4.0],
          [703.549, 1140.874, 4.0]
        ],
        segStyle: style_segment_turn
      },
      {
      ...
      {
        route: [
          [524.944, 1109.731, 4.0],
          [523.944, 1109.731, 4.0],
          [523.944, 1110.731, 4.0]
        ],
        segStyle: style_segment_turn
      },
      {
      ...
      {
        route: [
          [523.898, 1152.447, 4.0],
          [523.898, 1153.447, 4.0],
          [522.898, 1153.447, 4.0]
        ],
        segStyle: style_segment_turn
      },
      {
