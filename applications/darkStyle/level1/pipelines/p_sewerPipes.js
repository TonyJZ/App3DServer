...
var SewerPipeParams = [{
  ...
  routeArray: [{
    route: [[529.414, 403.982, 4.0], [528.621, 393.71, 4.0], [528.621, 392.71, 4.0]],
    segStyle: style_segment_zero
  }, {
    route: [[528.621, 392.71, 4.0], [528.792, 227.258, 4.0]],
    segStyle: style_segment_long
  }, {
    route: [[528.792, 227.258, 4.0], [528.792, 226.258, 4.0], [537.169, 213.752, 4.0], [557.076, 213.722, 4.0], [557.123, 203.767, 4.0], [569.942, 200.75, 4.0], [569.943, 199.36, 4.0]],
    segStyle: style_segment_zero
  }]
}, {
  name: "Line143",
  ...
  routeArray: [{
    ...
    route: [[621.717, 440.245, 4.0], [622.717, 440.245, 4.0], [635.974, 447.883, 4.0], [636.974, 447.883, 4.0]],
    segStyle: style_segment_zero
  }, {
    route: [[636.974, 447.883, 4.0], [670.025, 447.901, 4.0]],
    segStyle: style_segment_long
  }, {
    route: [[670.025, 447.901, 4.0], [671.025, 447.901, 4.0], [682.654, 441.244, 4.0], [701.573, 441.267, 4.0], [707.135, 431.967, 4.0], [707.135, 430.967, 4.0]],
    segStyle: style_segment_zero
  }, {
    route: [[707.135, 430.967, 4.0], [707.179, 376.921, 4.0]],
    segStyle: style_segment_long
  }, {
    route: [[707.179, 376.921, 4.0], [707.179, 375.921, 4.0], [705.162, 364.817, 4.0], [705.162, 363.817, 4.0]],
    segStyle: style_segment_zero
  }, {
  ...
  routeArray: [{
    ...
    route: [[646.027, 416.447, 4.0], [647.027, 416.447, 4.0], [647.027, 415.447, 4.0]],
  ...
  pipeStyle: style_blue,
  routeArray: [{
    route: [[234.54, 635.103, 4.0], [229.045, 623.179, 4.0], [232.053, 573.978, 4.0], [240.648, 573.972, 4.0], [240.659, 570.963, 4.0], [241.659, 570.963, 4.0]],
    segStyle: style_segment_zero
  }, {
    route: [[241.659, 570.963, 4.0], [255.915, 570.97, 4.0]],
    segStyle: style_segment_long
  }, {
    route: [[255.915, 570.97, 4.0], [256.915, 570.97, 4.0], [256.915, 569.97, 4.0]],
    segStyle: style_segment_turn
  }, {
  ...
  pipeStyle: style_blue,
  routeArray: [{
    route: [[378.063, 575.31, 4.0], [372.632, 574.651, 4.0], [372.632, 573.651, 4.0]],
    segStyle: style_segment_zero
  }, {
    route: [[372.632, 573.651, 4.0], [372.667, 554.446, 4.0]],
    segStyle: style_segment_long
  }, {
    route: [[372.667, 554.446, 4.0], [372.667, 553.446, 4.0], [373.667, 553.446, 4.0]],
    segStyle: style_segment_turn
  }, {
    route: [[373.667, 553.446, 4.0], [674.688, 553.681, 4.0]],
    segStyle: style_segment_long
  }, {
    route: [[674.688, 553.681, 4.0], [675.688, 553.681, 4.0], [675.688, 554.681, 4.0]],
    segStyle: style_segment_turn
  }, {
  ...
  pipeStyle: style_blue,
  routeArray: [{
    route: [[338.587, 730.739, 4.0], [337.478, 733.765, 4.0], [338.478, 733.765, 4.0]],
    segStyle: style_segment_zero
  }, {
    route: [[338.478, 733.765, 4.0], [599.582, 733.993, 4.0]],
    segStyle: style_segment_long
  }, {
    route: [[599.582, 733.993, 4.0], [600.582, 733.993, 4.0], [622.369, 741.346, 4.0], [635.205, 744.792, 4.0], [636.205, 744.792, 4.0]],
    segStyle: style_segment_zero
  }, {
    route: [[636.205, 744.792, 4.0], [668.628, 744.778, 4.0]],
    segStyle: style_segment_long
  }, {
    route: [[668.628, 744.778, 4.0], [669.628, 744.778, 4.0], [669.628, 743.778, 4.0]],
    segStyle: style_segment_turn
  }, {
    route: [[669.628, 743.778, 4.0], [669.663, 735.042, 4.0]],
    segStyle: style_segment_long
  }, {
    route: [[669.663, 735.042, 4.0], [669.663, 734.042, 4.0], [670.663, 734.042, 4.0]],
    segStyle: style_segment_turn
  }, {
    route: [[670.663, 734.042, 4.0], [674.532, 734.052, 4.0]],
    segStyle: style_segment_long
  }, {
    route: [[674.532, 734.052, 4.0], [675.532, 734.052, 4.0], [675.532, 733.052, 4.0]],
    segStyle: style_segment_turn
  }, {
  ...
  pipeStyle: style_blue,
  routeArray: [{
    route: [[675.604, 664.613, 4.0], [679.59, 664.481, 4.0], [679.59, 672.462, 4.0], [681.418, 672.462, 4.0], [687.596, 664.481, 4.0], [688.596, 664.481, 4.0]],
    segStyle: style_segment_zero
  }, {
    route: [[688.596, 664.481, 4.0], [726.564, 664.566, 4.0]],
    segStyle: style_segment_long
  }, {
    route: [[726.564, 664.566, 4.0], [727.564, 664.566, 4.0], [727.564, 663.566, 4.0]],
    segStyle: style_segment_turn
  }, {
  ...
  routeArray: [{
    ...
    route: [[703.543, 734.459, 4.0], [703.543, 735.459, 4.0], [702.543, 735.459, 4.0]],
    segStyle: style_segment_turn
  }, {
    route: [[702.543, 735.459, 4.0], [679.482, 735.461, 4.0]],
    segStyle: style_segment_long
  }, {
    route: [[679.482, 735.461, 4.0], [678.482, 735.461, 4.0], [675.534, 733.839, 4.0]],
    segStyle: style_segment_zero
  }]
}, {
  name: "Line159",
  ...
  routeArray: [{
    ...
    route: [[205.295, 1312.055, 4.0], [205.295, 1311.055, 4.0], [205.356, 1310.05, 4.0]],
    segStyle: style_segment_zero
  }, {
    route: [[205.356, 1310.05, 4.0], [216.898, 1122.08, 4.0]],
    segStyle: style_segment_long
  }, {
    route: [[216.898, 1122.08, 4.0], [216.959, 1121.078, 4.0], [212.304, 1107.036, 4.0], [212.365, 1106.036, 4.0]],
    segStyle: style_segment_zero
  }, {
    route: [[212.365, 1106.036, 4.0], [227.188, 863.208, 4.0]],
    segStyle: style_segment_long
  }, {
    route: [[227.188, 863.208, 4.0], [227.249, 862.208, 4.0], [228.249, 862.208, 4.0]],
    segStyle: style_segment_turn
  }, {
  ...
  pipeStyle: style_blue,
  routeArray: [{
    route: [[216.959, 1121.078, 4.0], [220.483, 1115.486, 4.0], [221.483, 1115.486, 4.0]],
    segStyle: style_segment_zero
  }, {
  ...
  pipeStyle: style_blue,
  routeArray: [{
    route: [[435.539, 862.369, 4.0], [441.136, 860.373, 4.0], [442.136, 860.373, 4.0]],
    segStyle: style_segment_zero
  }, {
  ...
  pipeStyle: style_blue,
  routeArray: [{
    route: [[469.44, 1097.606, 4.0], [469.359, 1105.715, 4.0], [474.913, 1112.693, 4.0], [475.913, 1112.693, 4.0]],
    segStyle: style_segment_zero
  }, {
    route: [[475.913, 1112.693, 4.0], [665.63, 1112.813, 4.0]],
    segStyle: style_segment_long
  }, {
    route: [[665.63, 1112.813, 4.0], [666.63, 1112.813, 4.0], [688.637, 1128.555, 4.0], [696.152, 1146.733, 4.0], [716.726, 1146.754, 4.0], [725.186, 1171.17, 4.0]],
    segStyle: style_segment_zero
  }]
}, {
  name: "Line205",
  pipeStyle: style_blue,
  routeArray: [{
    route: [[696.301, 1146.391, 4.0], [701.208, 1135.534, 4.0], [711.626, 1135.627, 4.0]],
    segStyle: style_segment_zero
  }]
}, {
  name: "Line206",
  ...
  routeArray: [{
    ...
    route: [[517.853, 1222.064, 4.0], [517.853, 1223.064, 4.0], [516.853, 1223.064, 4.0]],
    segStyle: style_segment_turn
  }, {
    route: [[516.853, 1223.064, 4.0], [470.323, 1223.065, 4.0]],
    segStyle: style_segment_long
  }, {
    route: [[470.323, 1223.065, 4.0], [469.323, 1223.065, 4.0], [469.323, 1224.065, 4.0]],
    segStyle: style_segment_turn
  }, {
    route: [[469.323, 1224.065, 4.0], [469.282, 1244.732, 4.0]],
    segStyle: style_segment_long
  }, {
    route: [[469.282, 1244.732, 4.0], [469.282, 1245.732, 4.0], [468.282, 1245.732, 4.0]],
    segStyle: style_segment_turn
  }, {
    route: [[468.282, 1245.732, 4.0], [254.678, 1245.546, 4.0]],
    segStyle: style_segment_long
  }, {
    route: [[254.678, 1245.546, 4.0], [253.678, 1245.546, 4.0], [253.678, 1244.546, 4.0]],
    segStyle: style_segment_turn
  }, {
    route: [[253.678, 1244.546, 4.0], [253.67, 1234.623, 4.0]],
    segStyle: style_segment_long
  }, {
    route: [[253.67, 1234.623, 4.0], [253.67, 1233.623, 4.0], [252.67, 1233.623, 4.0]],
    segStyle: style_segment_turn
  }, {
    route: [[252.67, 1233.623, 4.0], [247.128, 1233.639, 4.0]],
    segStyle: style_segment_long
  }, {
    route: [[247.128, 1233.639, 4.0], [246.128, 1233.639, 4.0], [246.145, 1232.857, 4.0], [245.145, 1232.857, 4.0]],
    segStyle: style_segment_zero
  }, {
    route: [[245.145, 1232.857, 4.0], [220.271, 1232.837, 4.0]],
    segStyle: style_segment_long
  }, {
    route: [[220.271, 1232.837, 4.0], [219.271, 1232.837, 4.0], [210.41, 1227.768, 4.0]],
    segStyle: style_segment_zero
  }]
}, {
  name: "Line207",
